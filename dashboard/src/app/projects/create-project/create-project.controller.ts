...
export class CreateProjectController {
  ...
  startWorkspace(workspace: che.IWorkspace): ng.IPromise<any> {
    ...
    let agentOutputHandler = (message: any) => {
    ...
    this.cheAPI.getWorkspace().getMasterApi().subscribeWsAgentOutput(workspaceId, agentOutputHandler);
    ...
    this.cheAPI.getWorkspace().getMasterApi().subscribeEnvironmentStatus(workspaceId, statusHandler);
  ...
  createProjectInWorkspace(workspaceId: string, projectName: string, projectData: any): void {
    ...
    if (this.selectSourceOption === 'select-source-new' && this.templatesChoice === 'templates-wizard') {
      ...
      this.cheAPI.getWorkspace().getWorkspaceAgent(workspaceId).getWsAgentApi().subscribeProjectImport(projectName, projectImportHandler);
